...
# 读取MM DICOM文件
mm_path = r'D:\4dflow\zhangyaozhong\MR_yaozhong\S17030\I11'
mm_raw = pydicom.dcmread(mm_path).pixel_array.astype(np.float32)
print(mm_raw.shape)
# 参数（根据实际情况调整）(1600, 128, 128)
num_timepoints =  20 # 20
...
# 输出目录
output_dir = r'D:\4dflow\zhangyaozhong\mm'
...
for t in range(num_timepoints):
    ...
    print(mesh)
    # # 保存为STL
    # stl_path = os.path.join(output_dir, f'yzmm_frame_{t+1}.stl')
    # mesh.save(stl_path)
